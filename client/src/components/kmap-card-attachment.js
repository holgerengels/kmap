    ...
    _renderAttachment() {
      if (this.attachment.type === "link")
        ...
        return html `
            ...
            <a href="${config.server}${this.attachment.href}" download="${this._isDownload}" target="${this._isTarget}" referrerpolicy="origin"><mwc-icon>cloud_download</mwc-icon></a>
        `;
      else
        return html `
            <a href="${config.server}${this.attachment.href}" ?download="${this._isDownload}" ?target="${this._isTarget}" referrerpolicy="origin">${this.attachment.name}</a>
        `;
