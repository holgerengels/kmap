  ...
  firstUpdated() {
    ...
    math(text, element) {
        if (text) {
            ...
            replace = replace.replace(/<integer ([0-9])\/>/g, "<input type='number' inputmode='numeric' maxsize='$1' style='width: $1em'/>");
            replace = replace.replace(/<decimal\/>/g, "<input type='number' inputmode='decimal' step='any'/>");
            replace = replace.replace(/<decimal ([0-9])\/>/g, "<input type='number' inputmode='decimal' step='any' maxsize='$1' style='width: $1em'/>");
    ...
    next(e) {
      this.dispatchEvent(new CustomEvent('next', { bubbles: true, detail: {
