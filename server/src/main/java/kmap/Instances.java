...
curl -X PUT -u $1 http://localhost:5984/$2-test/_design/test -d @design-test.json
    ...
    synchronized void createInstance(String json) {
        try {
            ...
            entity = new InputStreamEntity(Files.newInputStream(Paths.get(getProperty("context.path") + "WEB-INF/classes/couchdb/design-test.json")));
            entity.setContentType("application/json");
            put.setEntity(entity);
            ...
            entity = new InputStreamEntity(Files.newInputStream(Paths.get(getProperty("context.path") + "WEB-INF/classes/couchdb/design-course.json")));
            entity.setContentType("application/json");
            put.setEntity(entity);
